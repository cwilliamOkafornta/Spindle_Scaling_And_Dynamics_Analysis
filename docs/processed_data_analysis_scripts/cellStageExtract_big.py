...
def extract2cellstage_big(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'big_2-cell.csv'), index=False)
    
######################################################################################################################################

def extract4cellstage_big(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'big_4-cell.csv'), index=False)
    
######################################################################################################################################

def extract8cellstage_big(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'big_8-cell.csv'), index=False)
    
######################################################################################################################################

def extract16cellstage_big(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'big_16-cell.csv'), index=False)
    
######################################################################################################################################

def extract32cellstage_big(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'big_32-cell.csv'), index=False)
    
######################################################################################################################################

def extract64cellstage_big(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'big_64-cell.csv'), index=False)