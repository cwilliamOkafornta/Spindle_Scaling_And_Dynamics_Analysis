...
def extract2cellstage_small(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'small_2-cell.csv'), index=False)
    
######################################################################################################################################

def extract4cellstage_small(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'small_4-cell.csv'), index=False)
    
######################################################################################################################################

def extract8cellstage_small(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'small_8-cell.csv'), index=False)
    
######################################################################################################################################

def extract16cellstage_small(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'small_16-cell.csv'), index=False)
    
######################################################################################################################################

def extract32cellstage_small(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'small_32-cell.csv'), index=False)
    
######################################################################################################################################

def extract64cellstage_small(input_folder, output_folder, file_input, parameter):
    ...
    # save
    df_new_table.to_csv(os.path.join(output_folder, 'small_64-cell.csv'), index=False)